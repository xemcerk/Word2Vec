...
def parse_args():
    ...
    parser.add_argument('--vocab', type=str, default='./data/train.txt', help="corpus path for building vocab")
    parser.add_argument('--corpus', type=str, default='./data/train.txt', help="corpus path")
